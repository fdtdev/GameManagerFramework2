...
/**
 *
 * changed to inherit from com.FDT.Common.MonoBase
 * original version available in http://wiki.unity3d.com/index.php/Secure_UnitySingleton
 * 
**/
#endregion 
/*
...
{
	public abstract class UnitySingleton<T> : MonoBase where T : MonoBehaviour
	{
		/// <summary>
